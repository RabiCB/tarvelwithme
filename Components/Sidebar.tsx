...
const Sidebar = () => {
  ...
  return (
    <div className="flex flex-col transition-all flex-1 min-w-[20%] list-none max-w-screen-xl min-h-screen justify-start items-center pt-[10%]  overflow-hidden gap-8  max-md:hidden">
